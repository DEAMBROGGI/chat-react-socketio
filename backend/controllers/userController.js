...
let mailOptions ={
    ...
    html:  `Presiona <a href=http://localhost:4000/api/verify/${uniqueString}>aqui</a> para confirma tu email. Gracias`
};
    ...
    nuevoUsuario: async(req, res) => {
        ...
        try {
            ...
            if (usuarioExiste){
                ...
                res.json({success: true, response: {token,nuevoUsuario}, //RESPONDE CON EL TOKEN Y EL NUEVO USUARIO
                          message: "Te enviamos un email para validarlo, por favor verifica tu casilla para completar el signUp " }) // AGREGAMOS MENSAJE DE VERIFICACION
            }
            }
        }catch(error){
            console.log(error)
